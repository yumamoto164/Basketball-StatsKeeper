...
def player_entry():
    global home_team, away_team, home_list, away_list, home_entry, away_entry, error_label, home_number_entries, home_player_entries, away_number_entries, away_player_entries, base
    home_number_entries = []
    home_player_entries = []
    away_number_entries = []
    away_player_entries = []
    ...
    base.mainloop()
    return home_team, away_team, home_list, away_list
